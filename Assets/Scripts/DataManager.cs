...
public class DataManager : MonoBehaviour
{
	...
	{
		new Idea("A [damsel/gentleman/puppy] in distress", new Genre[] { Genre.Adventure, Genre.Romance, Genre.Tragedy }),
			new Idea("A [weapon/knife/gun] is found", new Genre[] { Genre.Tragedy, Genre.Mystery, Genre.Suspense }),
			new Idea("A [silly/crazy/stupid] romp", new Genre[] { Genre.Action, Genre.Comedy, Genre.Weird }),
			new Idea("A betrayal", new Genre[] { Genre.Action, Genre.Romance, Genre.Mystery }),
			new Idea("A surprising reveal", new Genre[] { Genre.Comedy, Genre.Tragedy, Genre.Mystery }),
			new Idea("A city of [gold/treasure/wonder/ruins]", new Genre[] { Genre.Action, Genre.Adventure }),
			new Idea("A desperate act", new Genre[] { Genre.Action, Genre.Adventure, Genre.Tragedy }),
			new Idea("A [horrible/disturbing] outcome", new Genre[] { Genre.Horror, Genre.Tragedy }),
			new Idea("A dystopian future", new Genre[] { Genre.Tragedy, Genre.Weird, Genre.Science }),
			new Idea("A fleeting view of [a woman/a man/a puppy/someone] ", new Genre[] { Genre.Adventure, Genre.Romance, Genre.Mystery }),
			new Idea("A fortuitous encounter", new Genre[] { Genre.Adventure, Genre.Comedy, Genre.Romance }),
			new Idea("A [lost/remembered] love", new Genre[] { Genre.Romance, Genre.Tragedy }),
			new Idea("A [new/shocking] discovery", new Genre[] { Genre.Adventure, Genre.Suspense }),
